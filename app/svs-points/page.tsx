...
// SVS当日の役職スキル(+50%)・執政官スキル(+30%)を実際に使った時のデータで加算モデルを検証済み(誤差3%以内)
...
function Day4Training() {
  ...
  const secPerTroop = adjustSecForSpeedBonus(
    mode === "train" ? trainRate.secPerTroop : PROMOTE_SEC_PER_TROOP,
    extraSpeedBonusPct
  );
